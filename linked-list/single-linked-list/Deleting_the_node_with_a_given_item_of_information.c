...
struct node *Deleting_the_node_with_a_given_item_of_information(struct node *head,int node)
{
    if(head==NULL)
    {
...
int main()
{
    ...
    printf("\nEnter a Node : \n");
    scanf("%d",&node);
    head = Deleting_the_node_with_a_given_item_of_information(head,node);
