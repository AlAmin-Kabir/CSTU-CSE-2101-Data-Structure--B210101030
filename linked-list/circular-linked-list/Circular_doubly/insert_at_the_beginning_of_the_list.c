...
struct node *add_the_beginning_of_the_list(struct node *tail,int data)
{
...
int main()
{
    ...
    int data;
    printf("Enter element for inserting beginning : \n");
    scanf("%d",&data);
    tail = add_the_beginning_of_the_list(tail,data);
